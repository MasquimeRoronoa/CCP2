 ...
 */
final class Version20210621072629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos ADD categories_id INT NOT NULL, ADD techniques_id INT NOT NULL, ADD photographe_id INT NOT NULL');

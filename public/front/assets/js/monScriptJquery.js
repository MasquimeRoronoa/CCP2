...
$(document).ready(function () {
    ...
    /*
Test fonction photo de footer a affichage central
 */
    ...
    $(".imgfoot").click(function (event) {
        ...
        $("#p1").text(this.getAttribute('data-photographe'))
        $("#p2").text(this.getAttribute('data-tech'))
        $("#p3").text(this.getAttribute('data-appareil'))
        $("#p4").text(this.getAttribute('data-objectif'))
        $("#p5").text(this.getAttribute('data-dimension'))
        $("#p6").text(this.getAttribute('data-vitesse'))
        $("#p7").text(this.getAttribute('data-iso'))
        $("#p8").text(this.getAttribute('data-focale'))
    })
